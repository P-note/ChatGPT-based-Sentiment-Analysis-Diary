...
def analyze_sentiment(review):
    completion = client.chat.completions.create(
        model="gpt-4o-mini",
        messages=[
            {"role": "system", "content": "You are a professional in sentiment analysis. Check the review data given, and find out whether the sentiment is positive or negative. you may answer with 'positive' or 'negative'. don't print anything else."},
            {
                "role": "user",
